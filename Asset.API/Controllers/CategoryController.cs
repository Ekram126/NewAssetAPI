    ...
    public class CategoryController : ControllerBase
    {
        ...
        public IActionResult Update(EditCategoryVM CategoryVM)
        {
            try
            {
                ...
                {
                    return StatusCode(StatusCodes.Status500InternalServerError, new Response { Status = "name", Message = "Category arabic name already exist", MessageAr = "هذا الاسم مسجل سابقاً" });
                }

...
namespace Asset.API.Controllers
{
    ...
    public class WorkOrderController : ControllerBase
    {
        ...
        //            bodytable2.SetTotalWidth(new float[] { 70f, 60f, 80f, 90f, 90f, 90f, 92f, 70f, 80f, 90f });
        ...
        //            bodytable2.SetWidths(new int[] { 10, 7, 12, 15, 20, 10, 20, 17, 10, 20 });
        ...
        //    table.SetTotalWidth(new float[] { 70f, 60f, 80f, 90f, 90f, 90f, 92f, 70f, 80f, 90f });
        //    table.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
        //    table.HorizontalAlignment = Element.ALIGN_RIGHT;
        //    table.WidthPercentage = 100;
        //    table.PaddingTop = 200;
        //    table.HeaderRows = 1;
        //    table.SetWidths(new int[] { 15, 7, 12, 15, 20, 10, 20, 17, 10, 20 });
        //    System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
        ...
        //    string[] col = { "تاريخ الإغلاق", "الأولوية", "الحالة", "التاريخ", "الوصف", "الموضوع", "اسم الأصل", "السيريال", "الباركود", "الوقت" };
        ...
        //        if (item.PeriorityNameAr != null)
        //            table.AddCell(new PdfPCell(new Phrase(item.PeriorityNameAr, font)) { PaddingBottom = 5 });
        //        else
        //            table.AddCell(new PdfPCell(new Phrase(" ")) { PaddingBottom = 5 });

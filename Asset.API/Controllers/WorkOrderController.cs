...
namespace Asset.API.Controllers
{
    ...
    public class WorkOrderController : ControllerBase
    {
        ...
        public void CreateServiceRequestGeneratePDF(List<ExportWorkOrderVM> workOrders)
        {
            ...
            using (PdfStamper stamper = new PdfStamper(reader, memoryStream))
            {
                ...
                for (int i = 1; i <= pages; i++)
                {
                    ...
                    bodytable2.WriteSelectedRows(0, -1, 10, 440, stamper.GetUnderContent(i));
        ...
        {
            var lstData = _workOrderService.PrintListOfWorkOrders(workOrders).ToList();
        ...
        {
            //var file = _webHostingEnvironment.ContentRootPath + "/UploadedAttachments/WOReports/CreateWOCheckedReport.pdf";
